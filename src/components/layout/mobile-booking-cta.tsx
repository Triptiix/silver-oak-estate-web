      ...
      >
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="flex min-h-[48px] min-w-[48px] items-center justify-center rounded-[var(--soe-radius-control)] border border-[var(--soe-color-gold)]/60 bg-transparent text-[var(--soe-surface-text-primary)] hover:bg-white/10 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--soe-color-focus-ring)]"
          >
