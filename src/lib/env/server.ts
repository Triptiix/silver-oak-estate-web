...
export const envServer: ServerEnvironment = {
  ...
  get PAYMENT_PROVIDER_MODE() { return readServerField("PAYMENT_PROVIDER_MODE"); },
  ...
  get RAZORPAY_KEY_ID() { return readServerField("RAZORPAY_KEY_ID"); },
  get RAZORPAY_KEY_SECRET() { return readServerField("RAZORPAY_KEY_SECRET"); },
  get RAZORPAY_WEBHOOK_SECRET() { return readServerField("RAZORPAY_WEBHOOK_SECRET"); },
