...
- **Still open (card-acquiring / platform gates, distinct from the generic approvals):** **registered tax/business form (#2 — the owner approved contracting as an individual with no incorporated entity; whether a registered proprietorship or firm is required is undecided)**, registered business address (#3), **merchant of record for card acquiring (#4 — the approved item is the payment beneficiary #6, not an acquiring MoR)**, identity-document requirements (#11), overtime fee schedule (#23), **per-platform precedence detail (#36)**, **GST registration status (#42 — currently not GST registered; future GST to be disclosed before payment)**, accepted payment methods (#43), cash-payment limits (#44) and chargeback handling (#46) — all required before card-based online self-service booking. A legal-professional review remains recommended before high-volume paid bookings.
